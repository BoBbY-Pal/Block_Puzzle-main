...
namespace Hyperbyte
{
    ...
    public class GamePlayUI : Singleton<GamePlayUI>
    {
        ...
        public void StartGamePlay(GameMode gameMode)
        {
            ...
            #region My Changes
            currentGameMode = levelSO.Levels[level].Mode.GameMode;
            currentModeSettings = levelSO.Levels[level].Mode.GameModeSettings;
            currentLevel = levelSO.Levels[level];

            TargetController.Instance.GenerateTargetInstances(levelSO.Levels[level].Goal);
        ...
        {
            return levelSO.Levels[level].FixedBlockShape.ToList();
        }

        public List<BlockShapeInfo> GetStandardBlockShapes()
        {
            return levelSO.BlockShape.StandardBlockShape.ToList();
        }

        // Returns of list of all advanced block shapes.
        public List<BlockShapeInfo> GetAdvancedBlockShapes()
        {
            return levelSO.BlockShape.AdvanceBlockShape.ToList();
        }
